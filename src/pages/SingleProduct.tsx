...
import dataT from '../data/db.json'; 
...
const SingleProduct = () => {
  ...
  useEffect(() => {
    setSingleProduct(dataT.products[parseInt(params.id||"1")-1]);
    setProducts(dataT.products);
  }, [params.id]); 
    ...
    <div className="max-w-screen-2xl mx-auto px-5 max-[400px]:px-3">
      <div className="grid grid-cols-3 gap-x-8 max-lg:grid-cols-1">
        <div className="lg:col-span-2">
          <img
            src={params.id=="1"?luxury1:params.id=="2"? luxury2: params.id=="3"?luxury3:params.id=="4"?luxury4:params.id=="5"?luxury5:luxury6}
